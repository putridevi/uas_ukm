...
if(isset($_GET['aksi']) == '') {        
        ...
        echo "<h3><a href='ms-view-user.php?aksi=tambah'>Tambah User</a> | <a href='index.php'>Home</a> | <a href='ms-view-user.php'>Pengelolaan User</a></h3>";
        echo "<table border='1'>";
        ...
        if($id_ukm!="Pilih Ukm" && $username!="" && $password!=""){
